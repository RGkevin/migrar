...
migrar/3.8.5 darwin-x64 node-v15.4.0
$ migrar --help [COMMAND]
USAGE
  $ migrar COMMAND
...
...
_See code: [src/commands/controller.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/controller.js)_
...
_See code: [src/commands/extensions.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/extensions.js)_
...
_See code: [src/commands/fix.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/fix.js)_
...
_See code: [src/commands/form.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/form.js)_
...
_See code: [src/commands/modules.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/modules.js)_
...
_See code: [src/commands/property.js](https://github.com/RGkevin/migrar/blob/v3.8.5/src/commands/property.js)_
<!-- commandsstop -->
